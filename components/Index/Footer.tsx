...
// from https://tailwindcomponents.com/component/gradiant-footer
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-100  via-[#bce1ff] to-gray-100 dark:from-black dark:via-[#18181b] dark:to-black">
      ...
      <div className="max-w-screen-xl px-4 pt-16 pb-8 mx-auto sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="max-w-xs mt-4 text-sm text-gray-600">
              Enable everyone to quickly write high-quality Prompts!
            </p>
            <div className="flex mt-8 space-x-6 text-gray-600">
              <Link className="hover:opacity-75" target="_blank" rel="noreferrer">
          ...
          <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                {siteConfig && siteConfig.Shortcut.map(item => (
                  <Link key={item.label} className="hover:opacity-75" href={item.href} > {item.label} </Link>
            ...
            <div>
              ...
              <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                {siteConfig && siteConfig.navItems.map(item=>(
                  <Link key={item.label} className="hover:opacity-75" href={item.href} > {item.label} </Link>
        ...
        <div className="w-full flex flex-col items-center justify-center  pt-10">
          <p className="mb-2 text-xs text-gray-800 dark:text-gray-300">
            © 2023 ChatAiWizard
          </p>
          <Link
            isExternal
